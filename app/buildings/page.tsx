  ...
  return (
    <main className="min-h-screen bg-background">
      ...
      <header className="border-b bg-uniandes-dark text-white">
        <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-bold leading-tight">AulaFinder</h1>
      ...
      <Modal open={showHelp} onOpenChange={setShowHelp}>
        <ModalContent>
          <ModalHeader>
            <ModalTitle>Acerca de AulaFinder</ModalTitle>
          </ModalHeader>
          <div className="mt-4 space-y-4 text-sm">
            <p>
              <strong>AulaFinder</strong> te ayuda a encontrar aulas disponibles en el campus de la
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                <a
                  href="https://github.com/Open-Source-Uniandes/AulaFinder/issues"
                  target="_blank"
